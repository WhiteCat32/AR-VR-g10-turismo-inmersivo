# Turismo Inmersivo Local con Vuforia
...
App de turismo AR/VR para sitios históricos locales con tours virtuales y guías interactivas.

| Campo | Detalle |
|-------|---------|
| **Tipo XR** | AR + VR |
| **Motor** | Unity 2022.3.62f1 |
| **Tecnología principal** | Vuforia Engine + Google Cardboard + AR Foundation |
...
- AR Foundation 5.1.x
- Vuforia Engine + Google Cardboard + AR Foundation

### Clonar el repositorio

```bash
git clone https://github.com/RubenCarty/rva-g10-turismo-inmersivo.git
cd rva-g10-turismo-inmersivo
```
